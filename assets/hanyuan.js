$(document).ready(function() {
	...
	$('.hanyuan-info .back-btn').click(function() {
		$('.hanyuan-info').transition({
		    animation : 'scale',
		    onComplete  : function() {
	...
	$('.card.hanyuan').click(function() {
		$('.project_main').transition({
		    animation : 'scale',
		    onComplete  : function() {
		      $('.project_main').removeClass("stackable");
		      $('.hanyuan-info').transition('scale');
		    }
		  });
	});

	var $imgs = $('.hanyuan-info .card .image img'), current = 0;
